  ...
  specialties: [
    {
      ...
      description: "Especialización en IA aplicada a datos clínicos y gestión biomédica.",
      icon: "brain"
    },
    {
      title: "Análisis de Datos",
      description: "Transformación de datos en insights con **Python, SQL y Power BI**.",
      icon: "database"
    },
    {
      title: "Ingeniería Biomédica",
      description: "Gestión tecnológica hospitalaria y mantenimiento de equipos médicos.",
      icon: "briefcase"
    }
  ],
  summary: [
...
export const experienceData: Experience[] = [
  {
    ...
    empresa: 'IPS Municipal de Ipiales',
    periodo: 'Febrero 2026 – Actualidad',
    ubicacion: 'Ipiales, Nariño, Colombia',
    icon: 'corporate',
    logros: [
      '## RESPONSABILIDADES Y LOGROS',
      'Coordino la gestión técnica de más de 3,000 equipos médicos en múltiples sedes, liderando iniciativas de mantenimiento preventivo y correctivo.',
      '#### Gestión Estratégica:',
      '- Realizo seguimiento estratégico a cronogramas de mantenimiento, asegurando cumplimiento oportuno de actividades programadas y optimizando tiempos de respuesta.',
      '- Desarrollo y administro documentación técnica completa, facilitando trazabilidad, auditorías internas y cumplimiento de normativas.',
      '#### Liderazgo y Capacitación:',
      '- Dirijo capacitaciones especializadas en gestión de tecnología biomédica y mejora del uso seguro de equipos a personal clínico y administrativo.',
      '#### Seguridad y Coordinación:',
      '- Apoyo al área de tecnovigilancia en identificación, análisis y reporte de eventos adversos asociados a dispositivos médicos.',
      '- Establezco comunicación efectiva con proveedores externos, coordinando servicios técnicos especializados.',
      '- Colaboro con diversos departamentos hospitalarios para asegurar operatividad de equipos críticos.',
      '## TECNOLOGÍAS CLAVE',
      'Gestión de Inventarios, Mantenimiento Biomédico, Tecnovigilancia, Normativa de Salud, Liderazgo Técnico.',
      '## IMPACTO',
      '✅ Garantía de disponibilidad operativa continua de más de 3,000 equipos médicos.',
    ]
  },
  {
  ...
  },
  {
    ...
    logros: [
      '## RESPONSABILIDADES Y LOGROS',
      'Gestión integral de tecnología biomédica para el sector odontológico, garantizando altos estándares de disponibilidad.',
  ...
  },
  {
    ...
    logros: [
      '## RESPONSABILIDADES Y LOGROS',
      'Como investigador, desarrollé algoritmos de simulación de nanopartículas y procesé grandes volúmenes de datos. Como monitor, impartí tutorías en diseño de circuitos y programación.',
...
export const skillsData = {
  programacion: {
    ...
    icon: "programacion",
    items: ['Python', 'R', 'SQL', 'C++', 'MATLAB', 'Arduino', 'Power BI', 'Looker Studio', 'AppScript', 'Streamlit', 'Excel Avanzado', 'Tableau', 'Firebase', 'Google Workspace', 'Google Colab'],
  },
  ia: {
    title: "Inteligencia Artificial y Machine Learning",
    icon: "ia",
    items: ['Modelado Predictivo', 'Machine Learning', 'Deep Learning', 'Análisis Estadístico', 'Scikit-learn', 'TensorFlow', 'OpenCV', 'Pandas', 'NumPy', 'ChatGPT', 'Gemini', 'Claude', 'Antigravity'],
  },
  profesionales: {
...
export const projectsData: Project[] = [
  ...
  },
  {
    ...
    description: "Análisis integral que explora tendencias y patrones en canciones populares hasta 2023. Incluye procesamiento de datos con **Python y R**, dashboard interactivo en **Looker Studio** y video de sustentación.",
    imageUrlId: "4",
  ...
  {
    id: "proj7",
    title: "Aprender es un Juego: Geometría",
  ...
  {
    id: "proj8",
    title: "Nacimientos en Caldas (2010-2024)",
    description: "Dashboard de Power BI que analiza los nacimientos por residencia en el departamento de Caldas. Incluye visualizaciones interactivas de tendencias y distribuciones geográficas.",
    imageUrlId: "8",
